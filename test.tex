\documentclass[10pt,foldmark,notumble,draft]{leaflet}
...
\AddToBackground{1}{%  Background of a small page
  \put(115,530){\includegraphics[scale=0.12]{TonyRyanHeadShot}}}
...
\includegraphics[scale=0.5]{TonyRyanHeadShot}
\section{Parking}
...
\includegraphics[scale=0.72]{TonyRyanHeadShot}
